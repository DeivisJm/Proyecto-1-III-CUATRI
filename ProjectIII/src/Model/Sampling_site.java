...
public class Sampling_site {
    ...
    public Sampling_site() {
    }

    public Sampling_site(int id, String name, int province_id, int canton_id, int district_id, int entity_id) {
        this.id = id;
        this.name = name;
    ...
    public Sampling_site(String name, int province_id, int canton_id, int district_id, int entity_id) {
        this.name = name;
        this.province_id = province_id;
        this.canton_id = canton_id;
        this.district_id = district_id;
